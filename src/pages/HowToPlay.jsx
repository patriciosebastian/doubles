  ...
  return (
    <div className="w-4/5 mx-auto mb-12">
      ...
      <section className="mb-8">
        ...
        <p>
          To start, either type your answer in the number input, click the “New Number” button or press <strong>↵ Enter</strong> after a game over. A random number between 2 and 100 will appear. Then, simply type the doubled result into the input box and hit <strong>↵ Enter</strong>. If you answer correctly, your streak increases by one and the next challenge begins instantly. One mistake or time-out ends the game, showing your final streak and allowing you to replay.
        </p>
      </section>
