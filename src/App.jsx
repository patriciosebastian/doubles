  ...
  return (
    <>
      <div className='relative'>
        <h1 className='text-4xl sm:text-5xl md:text-6xl font-bold text-center mt-4 mb-6'>
          Doubles
        </h1>
        <div className='ml-auto absolute right-0 top-[0.85rem] md:top-6'>
          ...
          <SettingsMenu
            ...
            handleCustomStartChange={handleCustomStartChange}
            handleCustomStartSubmit={handleCustomStartSubmit}
            clearCustomStart={clearCustomStart}
            mode={mode}
      ...
      <Footer isDetailsOpen={isDetailsOpen} />
    </>
  );
}
